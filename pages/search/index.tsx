        ...
        switch (type) {
            case 'asset':
                return (
                    <AssetInfo
                        unitName={
                            searchData?.data?.asset?.params?.['unit-name']
                        }
                        ...
                        metaDataHash={
                            searchData?.data?.asset?.params?.['metadata-hash']
                        }
            ...
            case 'application':
                return (
                    <ApplicationInfo
                        ...
                        createdAtRound={
                            searchData?.data?.application?.['created-at-round']
                        }
                        creator={searchData?.data?.application?.params?.creator}
                        globalState={
                            searchData?.data?.application?.params?.[
                                'global-state'
                            ]
                        }
                        globalStateSchema={
                ...
                return (
                    <AccountInfo
                        ...
                        amountWithoutPendingRewards={
                            searchData?.data?.account?.[
                                'amount-without-pending-rewards'
                            ]
                        }
                        assets={searchData?.data?.account?.assets}
                        createdAssets={
                            searchData?.data?.account?.['created-assets']
                        }
                        createdAtRound={
                            searchData?.data?.account?.['created-at-round']
                        }
                        deleted={searchData?.data?.account?.deleted}
                        pendingRewards={
                            searchData?.data?.account?.['pending-rewards']
                        }
            ...
            case 'transaction':
                return (
                    <TransactionInfo
                        ...
                        confirmedRound={
                            searchData?.data?.transaction?.['confirmed-round']
                        }
                        paymentTransaction={
                            searchData?.data?.transaction?.[
                                'payment-transaction'
                            ]
                        }
                        ...
                        transactionType={
                            searchData?.data?.transaction?.['tx-type']
                        }
                        ...
                        roundTime={
                            searchData?.data?.transaction?.['round-time']
                        }
                        createdAssetIndex={
                            searchData?.data?.transaction?.[
                                'created-asset-index'
            ...
            case 'block':
                return (
                    <BlockInfo
                        ...
                        previousBlockHash={
                            searchData?.data?.['previous-block-hash']
                        }
                        ...
                        transactionsRoot={
                            searchData?.data?.['transactions-root']
                        }
